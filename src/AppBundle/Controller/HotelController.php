...
class HotelController extends Controller {
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_hotel_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Hotel $entity)
    {
        $form = $this->createForm(new HotelType(), $entity, array(
            'action' => $this->generateUrl('admin_hotel_create'),
            'method' => 'POST',
        ));
    ...
    {
        $form = $this->createForm(new HotelType(), $entity, array(
            'action' => $this->generateUrl('admin_hotel_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_hotel_update")
     * @Method("PUT")
     ...
     *
     * @Route("/{id}", name="admin_hotel_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
                        ->setAction($this->generateUrl('admin_hotel_delete', array('id' => $id)))
                        ->setMethod('DELETE')
